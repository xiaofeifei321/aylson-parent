		...
		<c:if test="${!empty  quotationVo.detailDWVoList}">
			<c:forEach items="${quotationVo.detailDWVoList}" var="detailDWVo">
				<tr class='detail_tr'>
					...
					<td><input value="${detailDWVo.areas }" id='areas' data-options='precision:2,required:true,min:1' class='easyui-numberbox areasCss' /></td>
					<td><input value="${detailDWVo.unitPrice }" id='unitPrice' data-options='precision:2,required:true,min:1' class='easyui-numberbox unitPriceCss' /></td>
					<td>
					...
					<td><input value="${detailDWVo.amount }" id='amount' data-options='precision:2,min:1' class='easyui-numberbox amountCss' /></td>
			...
			<tr id="remark_tr">
				...
				<input type="hidden" name="remark" id="quotationRemark" value=""/>
				</td>
				<td colspan="3" style="text-align:right;">合计金额：（元）</td>
				<td ><input id="orderAmount" name="orderAmount" readonly="true" data-options="min:0,precision:2" value="0" class="easyui-numberbox orderAmountCss" /></td>
				<td >---</td>
				<td >---</td>
			</tr>
			<tr>
				...
				<td ><input id="benefitAmount" name="benefitAmount" data-options="min:0,precision:2,
				onChange:function(newValue,oldValue){
					realAmountCount(null,newValue);
				}
				" value="0" class="easyui-numberbox benefitAmountCss"/></td>
				<td colspan="2" style="text-align:right;">折后金额：（元）</td>
				<td ><input id="realAmount" name="realAmount" data-options="readonly:true,precision:2,min:0" value="0" class="easyui-numberbox realAmountCss"/></td>
				<td colspan="3" style="text-align:right;">货物出厂前应付金额：（元）</td>
				<td ><input id="remainAmount" name="remainAmount" data-options="precision:2,min:0" value="0" class="easyui-numberbox remainAmountCss"/>
				</td>
				<td >---</td>
				<td >---</td>
			</tr>
