...
<div align="center">
	<form id="orderForm" method="post">
		<table class="tableForm">
		    ...
		    <tr>
				<th>结算金额：</th>
				<td><input  id="settleAmount" value="${quotationVo.salesAmount-quotationVo.deposit-quotationVo.benefitAmount-quotationVo.couponValue}"
					class="easyui-numberbox" data-options="readonly:true,precision:2"
					style="width: 200px;" /></td>
				<td colspan="2">
					结算金额 = 销售金额 - 定金 - 优惠金额 - 现金券减免金额
				</td>
		    </tr>
		</table>
...
//计算计算金额
	...
	function countCouponValueSum(partnerCouponValue){
		...
		$("#couponValueSum").numberbox('setValue',couponValueSum);
