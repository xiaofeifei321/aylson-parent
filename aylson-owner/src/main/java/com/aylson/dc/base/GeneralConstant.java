...
public interface GeneralConstant {
	...
	/*public abstract class AttachmentType {
		*//*** 工程方案需求附件 *//*
		public static final int PROJECT_PROGRAM = 1;
		*//*** 工程设计附件  *//*
		public static final int PROJECT_DESIGN = 2;
		*//*** 成功案例附件  *//*
		public static final int PROJECT_SUCCESSCASE = 3;
		
		public static Map<Integer, String> AttachmentTypeMap = new HashMap<Integer, String>();
		static {
			AttachmentTypeMap.put(PROJECT_PROGRAM, "工程方案需求附件");
			AttachmentTypeMap.put(PROJECT_DESIGN, "工程设计附件");
			AttachmentTypeMap.put(PROJECT_SUCCESSCASE, "成功案例附件");
		}
	}*/
	...
	public abstract class QRCodeChannel {
		...
		/*** 代理商分享业主 */
		public static final String AGENT_OWNER = "agentOwner";
