...
<body class="easyui-layout" fit="true">
	<!-- 门店展示管理 查询 --> 
	<div region="north"  id="storeArea" style="white-space: nowrap;padding: 5px; height: 50px;">
		<div style="margin-bottom: 5px">
			<form id="storeSearchForm"  method="post">
				<table class="table_content"   border="0" >
					<tr>
						<td class="tar" >门店名称：</td>
						<td class="tal" >
							<input class="easyui-textbox" name="storeNameLike" prompt="模糊查询"/>
						</td>
...
<script type="text/javascript" charset="UTF-8" src="<%=request.getContextPath()%>/resources/js/aylson/sys/store.js?date=2016122904"></script>
</html>