...
<body class="easyui-layout" fit="true">
	<div region="north"  id="noticeArea" style="white-space: nowrap;padding: 5px; height: 50px;">
			...
			<form id="noticeSearchForm"  method="post">
				<table class="table_content"   border="0" >
					<tr>
						<td class="tar" >标题：</td>
						<td class="tal" >
							<input name="titleLike" class="easyui-textbox"  style="width: 120px;" />
						</td>
						<td class="tar" >发布时间：</td>
						<td class="tal" >
							<input name="publishTime" class="easyui-datebox"  style="width: 120px;" />
						</td>
...
<script type="text/javascript" charset="UTF-8" src="<%=request.getContextPath()%>/resources/js/aylson/sys/notice.js?date=2017011800"></script>
</html>