...
<body class="easyui-layout" fit="true">
	<div region="north"  id="couponArea" style="white-space: nowrap;padding: 5px; height: 80px;">
			...
			<form id="couponSearchForm"  method="post">
				<table class="table_content"   border="0" >
					<tr>
						<td>券号：</td>
						<td>							
							<input class="easyui-textbox" name="couponCodeLike" style="width: 120px;" prompt="模糊查询"/>
						</td>
						<td>客户姓名：</td>
						<td>							
					...
					<tr>
						...
						<td>使用/失效时间：</td>
						<td>							
							<input class="easyui-datebox" name="updateTime" style="width: 120px;" prompt="模糊查询"/>
						</td>
						<td colspan="2"></td>
...
<script type="text/javascript" charset="UTF-8" src="<%=request.getContextPath()%>/resources/js/aylson/partner/coupon.js?date=2017011705"></script>
</html>
