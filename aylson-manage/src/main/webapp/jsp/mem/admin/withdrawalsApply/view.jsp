...
<div align="center">
	<form id="withdrawalsApplyForm" method="post">
		<table class="tableForm">
			...
			<tr>
				<th>
				<a href="javascript:void(0)" class="easyui-linkbutton c8" onclick="uploadtTransferProof('transferItem','transferProof','dc-transferproof')" id="uploadFile" style="padding:2px;margin:5px">上传转账凭证</a>
				</th>
				<td colspan="3">
					<ul class="ul_1" id="transferItem">
						<c:forEach items="${transferProofList}" var="transferProof">
						<li>
							<img class="naviga_big" alt="" src="${transferProof }" style="width:50px;height:50px;">
						</li>
						</c:forEach>
					</ul>
