...
<body class="easyui-layout" fit="true">
	<div region="north" style="white-space: nowrap;padding: 5px; height: 50px;">
		<div style="margin-bottom: 5px">
			<form id="shareUserHisForm"  method="post">
				<table class="table_content"   border="0" >
					<tr>
						<td class="tar" >师傅手机号码：</td>
						<td class="tal" >
							<input class="easyui-textbox" name="masterPhoneNumLike" prompt="模糊查询"/>
						</td>
						<td class="tar" >徒弟手机号码：</td>
						<td class="tal" >
							<input class="easyui-textbox" name="studentPhoneNumLike" prompt="模糊查询"/>
						</td> 
...
<script type="text/javascript" charset="UTF-8" src="<%=request.getContextPath()%>/resources/js/aylson/qmtt/shareUserHis.js?date=2016112516"></script>
</html>