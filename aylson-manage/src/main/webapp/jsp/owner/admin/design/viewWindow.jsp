			...
			<c:if test="${!empty designVo.designDetailDWList }">
				<c:forEach items="${designVo.designDetailDWList}" var="designDetailDWVo">
					<tr class="detail_tr">
						...
						<td><input value='${designDetailDWVo.openFanNumW }' name="openFanNumW"  data-options="readonly:true" class="easyui-numberbox"/></td>
						...
						<td><input value='${designDetailDWVo.sillHeightW }' name="sillHeightW"  data-options="readonly:true" class="easyui-numberbox"/></td>
