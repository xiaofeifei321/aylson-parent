		...
		<div style="margin-bottom: 5px">
			<form id="couponSearchForm"  method="post">
				<table class="table_content"   border="0" >
					<tr>
						<td class="tar" >优惠券类型：</td>
						<td class="tal" >
							<select name="couponType" class="easyui-combobox"  style="width: 120px;" editable=false>
						...
						<td class="tal" >
							<select name="isEnabled" class="easyui-combobox"  style="width: 120px;" editable=false>
								<option value="">全部</option>
...
<script type="text/javascript" charset="UTF-8" src="<%=request.getContextPath()%>/resources/js/aylson/sys/couponDetail.js?date=2017030900"></script>
</html>