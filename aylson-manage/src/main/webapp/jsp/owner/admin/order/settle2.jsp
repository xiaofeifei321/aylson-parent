...
<div align="center">
	<form id="orderForm" method="post">
		<table class="tableForm">
			...
			<tr>
				<th>销售金额：</th>
				<td><input id="salesAmount"  value="${orderVo.salesAmount}"
					class="easyui-numberbox" data-options="readonly:true,precision:2"
					style="width: 200px;" /></td>
				<th>现金券减免金额：</th>
				<td><input  id="reductionAcount" value="${orderVo.reductionAcount}"
			...
			<%-- <tr>
				<th>优惠金额：</th>
				<td><input id="benefitAmount"  value="${quotationVo.benefitAmount}"
					class="easyui-numberbox" data-options="readonly:true,precision:2"
					style="width: 200px;" /></td>
				<th>现金券减免金额：</th>
				<td><input  id="couponValueSum" value="${quotationVo.couponValue+quotationVo.partnerCouponValue}"
					class="easyui-numberbox" data-options="readonly:true"
					style="width: 200px;" /></td>
		    </tr> --%>
		    ...
		    <tr>
				<th>结算金额：</th>
				<td><input  id="settleAmount" value="${orderVo.salesAmount-orderVo.reductionAcount}"
					class="easyui-numberbox" data-options="readonly:true,precision:2"
					style="width: 200px;" /></td>
				<td colspan="2">
					结算金额 = 销售金额 - 现金券减免金额
...
//计算计算金额
	function countSettleAmount(partnerCouponValue){
		...
		var settleAmount = salesAmount-partnerCouponValue;
	...
	function countCouponValueSum(partnerCouponValue){
		...
		$("#reductionAcount").numberbox('setValue',partnerCouponValue);
