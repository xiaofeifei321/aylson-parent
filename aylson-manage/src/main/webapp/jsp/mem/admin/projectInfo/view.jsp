	...
	<form id="projectInfoForm" method="post">
		<table class="tableForm">
			...
			<tr>
				...
				<th>结算金额：</th>
				<td>
				<input  name="amount" value="${projectDesignVo.amount }" readonly="true"
					class="easyui-numberbox" 	style="width: 200px;" />
				</td>
			</tr>
			<tr>
				<th>备注：</th>
				<td colspan="3"><input name="remark" value="${projectDesignVo.remark}" readonly="true"
					class="easyui-textbox" 	multiline="true" style="width: 400px;height:50px;" /></td>
			</tr>
