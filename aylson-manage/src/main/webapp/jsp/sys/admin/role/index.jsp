			...
			<form id="roleSearchForm"  method="post">
				<table class="table_content"   border="0" >
					<tr>
						...
						<td class="tal" >
							<input class="easyui-textbox" name="roleNameLike" prompt="模糊查询"/>
						</td>
...
<script type="text/javascript" charset="UTF-8" src="<%=request.getContextPath()%>/resources/js/aylson/sys/role.js?date=2016080507"></script>
</html>