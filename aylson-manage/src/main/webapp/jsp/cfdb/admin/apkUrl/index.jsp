...
<body class="easyui-layout" fit="true">
	<div region="north" style="white-space: nowrap;padding: 5px; height: 50px;">
		<div style="margin-bottom: 5px">
			<form id="apkUrlForm"  method="post">
				<table class="table_content"   border="0" >
					<tr>
						<td class="tar" >应用名称：</td>
						<td class="tal" >
							<input class="easyui-textbox" name="appNameLike" prompt="模糊查询"/>
						</td> 
...
<script type="text/javascript" charset="UTF-8" src="<%=request.getContextPath()%>/resources/js/aylson/cfdb/apkUrl.js?date=2016112516"></script>
</html>