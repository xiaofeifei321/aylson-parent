...
<body class="easyui-layout" fit="true">
	<!-- 反馈管理 查询 --> 
	<div region="north"  id="feedbackArea" style="white-space: nowrap;padding: 5px; height: 50px;">
		<div style="margin-bottom: 5px">
			<form id="feedbackSearchForm"  method="post">
				<table class="table_content"   border="0" >
					<tr>
						<td class="tar" >反馈时间：</td>
						<td class="tal" >
							<input class="easyui-datebox" name="feedbackTime" />
						</td>
						<!-- <td class="tar" >标题：</td>
						<td class="tal" >
...
<script type="text/javascript" charset="UTF-8" src="<%=request.getContextPath()%>/resources/js/aylson/sys/feedback.js?date=2016081703"></script>
</html>