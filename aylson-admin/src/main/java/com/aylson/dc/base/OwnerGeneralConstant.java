...
/*	public abstract class CostSourceType {
		...
		*//*** 订单 *//*
		...
		static {
			...
			CostSourceTypeMap.put(ORDER, "订单 ");
		}
	}*/
	
	public abstract class OrderFlowState {
		/*** 待经销商确认 */
		public static final int WAIT_AGENT_CONFRIM = 0;
		/*** 经销商已确认 */
		public static final int AGENT_CONFIRM = 1;
		/*** 总部确认*/
		public static final int ORG_CONFIRM = 2;
		
		
		public static Map<Integer, String> OrderFlowStateMap = new HashMap<Integer, String>();
		static {
			OrderFlowStateMap.put(WAIT_AGENT_CONFRIM, "待经销商确认");
			OrderFlowStateMap.put(AGENT_CONFIRM, "经销商已确认 ");
			OrderFlowStateMap.put(ORG_CONFIRM, "总部确认 ");
		}
	}
